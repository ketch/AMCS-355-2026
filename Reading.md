...
For each lecture, I'll provide references here.  In most cases, you aren't expected to read everything
that is referenced.  Required reading is in ***bold italics***.

## Sunday, February 1st
- For basic material on Runge-Kutta and linear multistep methods, see ***Chapter 5 of LeVeque*** as well as volume 1 of HNW.
- For an introduction to general linear methods, see [Butcher's review in Acta Numerica](https://www.cambridge.org/core/journals/acta-numerica/article/general-linear-methods/68B6D07A0CBC9AC5DE06ED4048A22A3F)

## Wednesday, February 4th: Error estimation and step size control
- Some basic ideas are laid out in ***LeVeque section 7.5***; review that first.
